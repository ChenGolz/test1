#!/usr/bin/env node
/**
 * Generate international brands JSON from a TSV file.
 ...
 *
 * Usage:
 *  node scripts/generate-intl-brands.mjs data/intl-brands.tsv > data/intl-brands.json
 */
...
if (!path) {
  console.error('Provide a TSV path. Example: node scripts/generate-intl-brands.mjs data/intl.tsv');
  process.exit(1);
}
